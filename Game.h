...
class GameState
{
	...
	std::function<bool(int, Type)> player1CountRequest;
	std::function<bool(int, Type)> player2CountRequest;
	std::function<bool(int, Type)> player3CountRequest;
	std::function<bool(int, Type)> player4CountRequest;
	...
	std::function<bool(Type, const std::vector<Suit>&)> player3SuitRequest;
	...
	const std::function<bool(int, Type)>& getPlayer1CountRequest() const;
	const std::function<bool(int, Type)>& getPlayer2CountRequest() const;
	const std::function<bool(int, Type)>& getPlayer3CountRequest() const;
	const std::function<bool(int, Type)>& getPlayer4CountRequest() const;
	...
	void setPlayer1CountRequest(const std::function<bool(int, Type)>&);
	void setPlayer2CountRequest(const std::function<bool(int, Type)>&);
	void setPlayer3CountRequest(const std::function<bool(int, Type)>&);
	void setPlayer4CountRequest(const std::function<bool(int, Type)>&);
	...
	__property const std::function<bool(int, Type)>& Player1CountRequest = { read = getPlayer1CountRequest, write = setPlayer1CountRequest };
	__property const std::function<bool(int, Type)>& Player2CountRequest = { read = getPlayer2CountRequest, write = setPlayer2CountRequest };
	__property const std::function<bool(int, Type)>& Player3CountRequest = { read = getPlayer3CountRequest, write = setPlayer3CountRequest };
	__property const std::function<bool(int, Type)>& Player4CountRequest = { read = getPlayer4CountRequest, write = setPlayer4CountRequest };
